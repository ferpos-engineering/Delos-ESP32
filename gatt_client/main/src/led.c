...
static struct led_states_t led_states[NUM_LED_STATES] = {
    ...
    [LED_DATALOSS] = { .red = 255, .green = 0, .blue = 0, .blink_frequency_hz = 0.0f, .duration_ms = 2000 },
    [LED_DISCONNECTED] = { .red = 255, .green = 255, .blue = 255, .blink_frequency_hz = 0.0f, .duration_ms = 0 },
    [LED_CONNECTED] = { .red = 0, .green = 0, .blue = 255, .blink_frequency_hz = 0.0f, .duration_ms = 0 },
...
static void strip_apply_state(uint8_t state_num)
{
    ...
    ESP_ERROR_CHECK(led_strip_set_pixel(led_strip, 0, s->red, s->green, s->blue));
